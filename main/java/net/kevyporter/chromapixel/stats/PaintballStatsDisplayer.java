...
public class PaintballStatsDisplayer
  extends StatsDisplayer
{
  public PaintballStatsDisplayer(String name)
  {
    super(name);
    getStats();
  }
  ...
  public void displayStatsInChat()
  {
    ...
    new ChatMessageComposer(this.playerName + "'s stats in " + GameType.PAINTBALL.getName(), EnumChatFormatting.GREEN).send();
  ...
  private void getStats()
  {
    try
    {
      this.coins = this.statistics.get("Paintball").getAsJsonObject().get("coins").getAsInt();
    }
    catch (Exception e) {}
    try
    {
      this.kills = this.statistics.get("Paintball").getAsJsonObject().get("kills").getAsInt();
    }
    catch (Exception e) {}
    try
    {
      this.wins = this.statistics.get("Paintball").getAsJsonObject().get("wins").getAsInt();
    }
    catch (Exception e) {}
  }
}
