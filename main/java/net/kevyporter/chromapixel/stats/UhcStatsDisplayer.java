...
public class UhcStatsDisplayer
  extends StatsDisplayer
{
  public UhcStatsDisplayer(String name)
  {
    super(name);
    getStats();
  }
  ...
  public void displayStatsInChat()
  {
    ...
    new ChatMessageComposer(this.playerName + "'s stats in " + GameType.UHC.getName(), EnumChatFormatting.GREEN).send();
  ...
  private void getStats()
  {
    try
    {
      this.coins = this.statistics.get("UHC").getAsJsonObject().get("coins").getAsInt();
    }
    catch (Exception e) {}
    try
    {
      this.kills = this.statistics.get("UHC").getAsJsonObject().get("kills").getAsInt();
    }
    catch (Exception e) {}
    try
    {
      this.wins = this.statistics.get("UHC").getAsJsonObject().get("wins").getAsInt();
    }
    catch (Exception e) {}
  }
}
