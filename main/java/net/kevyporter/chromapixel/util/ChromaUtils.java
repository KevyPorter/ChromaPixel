...
import net.kevyporter.chromapixel.commands.ChangeColorCommand;
import net.kevyporter.chromapixel.commands.Command;
...
public class ChromaUtils {
	...
	public static void register() {
		...
		ClientCommandHandler.instance.registerCommand(new ChangeColorCommand());
	}
